  ...
  return (
    <footer className="w-full bg-black text-white">
      ...
      <div className="px-4 sm:px-6 lg:px-16 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16 max-w-[1500px] mx-auto">
          ...
          <div className="w-full flex md:justify-center">
            <div className="flex flex-col items-start md:mx-auto">
              <p className="text-[#D4AF37] text-lg font-medium mb-1">
                Quick Links
              </p>
              <ul className="flex flex-col gap-1">
                <li>
                  <a href="#about-us" className="hover:text-[#D4AF37]">
                    About Us
                  </a>
                </li>
                <li>
                  <a href="#menu" className="hover:text-[#D4AF37]">
                    Our Menu
                  </a>
                </li>
                <li>
                  <a href="#location" className="hover:text-[#D4AF37]">
                    Location
                  </a>
                </li>
                <li>
                  <a href="#reserve" className="hover:text-[#D4AF37]">
                    Reservation
                  </a>
                </li>
              </ul>
          ...
          <div className="w-full flex md:justify-center">
            <div className="flex flex-col items-start md:mx-auto">
              ...
              <div className="mt-4">
                ...
                <p className="text-[#C8102E] text-base leading-6">
                  0131 555 0123
                </p>
              </div>
            </div>
